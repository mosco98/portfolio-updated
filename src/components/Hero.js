      ...
      <div className="container select-none">
        <AnimatePresence>
          ...
          >
            ...
            >
              I'm <span className="ml-4 font-extrabold text-red-500">M</span>
              oses.
            </motion.h1>
            <motion.div
            ...
            >
              ...
              <p className="mt-3 text-xl opacity-80">
                Team player, innovative, creative human seeking opportunities
                where I can make an impact with tech.
              </p>
            </motion.div>
          </motion.div>
        </AnimatePresence>
